...
class Potentials_Module_Model extends Vtiger_Module_Model {
	...
	public function getRelationQuery($recordId, $functionName, $relatedModule, $relationId) {
		if ($functionName === 'get_activities') {
			...
			//-- Creantis: Henry: 2018-11-09: se agrega vtiger_activitycf para poder mostrar campos CF en la vista relacionada
			$query = "SELECT CASE WHEN (vtiger_users.user_name not like '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
						...
						,vtiger_activitycf.*
						,CONCAT(vtiger_contactdetails.firstname,' ',vtiger_contactdetails.lastname) as 'lastname' 
