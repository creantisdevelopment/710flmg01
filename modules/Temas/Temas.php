...
class Temas extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_temas';
	var $table_index= 'temasid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_temascf', 'temasid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_temas', 'vtiger_temascf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_temas'   => 'temasid',
	    'vtiger_temascf' => 'temasid');
	...
	var $list_fields = Array (
		...
		'Temas No' => Array('temas', 'temasno'),
/*FIELDSTART*/'Regla'=> Array('temas', 'temas_tks_regla'),/*FIELDEND*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Temas No' => 'temasno',
/*FIELDSTART*/'Regla'=> 'temas_tks_regla',/*FIELDEND*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'temas_tks_regla';
...
/*FIELDSTART*/'Regla'=> 'temas_tks_regla',/*FIELDEND*/
	...
	var $popup_fields = Array ('temas_tks_regla');

	// For Alphabetical search
	var $def_basicsearch_col = 'temas_tks_regla';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'temas_tks_regla';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('temas_tks_regla','assigned_user_id');

	var $default_order_by = 'temas_tks_regla';
	...
	*/
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Temas'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Temas','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
