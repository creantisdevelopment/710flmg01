...
class Products_Popup_View extends Vtiger_Footer_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		if(!empty($apoderado_id)) {
			$listViewModel->set('apoderado_id', $apoderado_id);
			$listViewModel->set('alumno_id', $alumno_id);
			$listViewModel->set('alumno_nivel', $alumno_nivel);
			$listViewModel->set('alumno_grado', $alumno_grado);
			$listViewModel->set('alumno_seccion', $alumno_seccion);
			$listViewModel->set('alumno_anio', $alumno_anio);
		}
		...
		//-- para buscar curso desde incidencia
		$viewer->assign('APODERADO_ID', $apoderado_id);
		$viewer->assign('ALUMNO_ID', $alumno_id);
		$viewer->assign('ALUMNO_NIVEL', $alumno_nivel);
		$viewer->assign('ALUMNO_GRADO', $alumno_grado);
		$viewer->assign('ALUMNO_SECCION', $alumno_seccion);
		$viewer->assign('ALUMNO_ANIO', $alumno_anio);
