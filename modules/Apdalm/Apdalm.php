...
class Apdalm extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_apdalm';
	var $table_index= 'apdalmid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_apdalmcf', 'apdalmid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_apdalm', 'vtiger_apdalmcf');
	...
	var $related_tables = Array( 
					'vtiger_apdalmcf' => Array('apdalmid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_apdalm'   => 'apdalmid',
	    'vtiger_apdalmcf' => 'apdalmid');
	...
	var $list_fields = Array (
		...
		'Apdalm No' => Array('apdalm', 'apdalmno'),
/*FIELDSTART*/'Codigo Alumno'=> Array('apdalm', 'apdalm_tks_codigoalumno'),/*FIELDEND*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Apdalm No' => 'apdalmno',
/*FIELDSTART*/'Codigo Alumno'=> 'apdalm_tks_codigoalumno',/*FIELDEND*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'apdalm_tks_codigoalumno';
...
/*FIELDSTART*/'Codigo Alumno'=> 'apdalm_tks_codigoalumno',/*FIELDEND*/
	...
	var $popup_fields = Array ('apdalm_tks_codigoalumno');

	// For Alphabetical search
	var $def_basicsearch_col = 'apdalm_tks_codigoalumno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'apdalm_tks_codigoalumno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('apdalm_tks_codigoalumno','assigned_user_id');

	var $default_order_by = 'apdalm_tks_codigoalumno';
	...
	*/
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Apdalm'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Apdalm','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
