...
class Almsecc extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_almsecc';
	var $table_index= 'almseccid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_almsecccf', 'almseccid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_almsecc', 'vtiger_almsecccf');
	...
	var $related_tables = Array( 
					'vtiger_almsecccf' => Array('almseccid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_almsecc'   => 'almseccid',
	    'vtiger_almsecccf' => 'almseccid');
	...
	var $list_fields = Array (
		...
		'Almsecc No' => Array('almsecc', 'almseccno'),
/*FIELDSTART*/'Codigo Alumno'=> Array('almsecc', 'almsecc_tks_codigoalumno'),/*FIELDEND*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Almsecc No' => 'almseccno',
/*FIELDSTART*/'Codigo Alumno'=> 'almsecc_tks_codigoalumno',/*FIELDEND*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'almsecc_tks_codigoalumno';
...
/*FIELDSTART*/'Codigo Alumno'=> 'almsecc_tks_codigoalumno',/*FIELDEND*/
	...
	var $popup_fields = Array ('almsecc_tks_codigoalumno');

	// For Alphabetical search
	var $def_basicsearch_col = 'almsecc_tks_codigoalumno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'almsecc_tks_codigoalumno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('almsecc_tks_codigoalumno','assigned_user_id');

	var $default_order_by = 'almsecc_tks_codigoalumno';
	...
	*/
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Almsecc'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Almsecc','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
