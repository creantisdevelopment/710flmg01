	...
	<script type="text/javascript">
		Vtiger_MultiBarchat_Widget_Js('Vtiger_PipelinedAmountPerSalesPerson_Widget_Js',{},{
			getCharRelatedData : function() {
				...
				//--Henry# primer nombre y primera letra de apellido
				// console.log("data", data);
				// for(var k in data) {
				// 	var userData = data[k];
				// 	var aux = (userData.last_name).split(" ");
				// 	// console.log("aux", aux[0], aux[0] + " " + aux[1].substring(0, 1) + ".");
				// 	userData.last_name = aux[0] + " " + aux[1].substring(0, 1) + ".";
				// 	data[k] = userData;
				// }
				//--Henry# fin
				var users = new Array();
