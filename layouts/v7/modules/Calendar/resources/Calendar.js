...
//since support for multiple calendar views for events is enabled
	...
	registerPopoverEvent: function (event, element, calendarView) {
		// console.log("registerPopoverEvent", event, element, calendarView)
		//--Henry# para que se muestre el nombre del evento concatenado al nombre de la cuenta
		if ( (event.module == 'Events' || event.module == 'Calendar') && event.accountname != '' ){
			event.title += ' (Cuenta: ' + event.accountname + ')';
		}
