			...
			<div class="loginDiv widgetHeight">
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue">Iniciar</button><br>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							...
							<span>Por favor ingrese los detalles y envíe<a class="forgotPasswordLink pull-right" style="color: #15c;">Atrás</a></span>
						</div>
					</form>
				</div>
			</div>
