...
//					app.helper.showHorizontalScroll(jQuery('#reportDetails'));
	...
	registerConditionBlockChangeEvent : function() {
		//-- creantis-henry: order y top n
		jQuery('.reportsDetailHeader').find('#groupbyfield,#datafields,#dataOrder,#dataTopN,[name="columnname"],[name="comparator"]').on('change', function() {
