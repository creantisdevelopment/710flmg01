...
{if !empty($CHART_VALUES)}
    ...
    <div style="margin:0px 10px;">
        <div>
            {*Henry - Para alto de grafico, solo la primera vez que se carga el widget, original height: 245px; *}
            <div name='chartcontent' class="widgetChartContainer" data-type='Widget{$WIDGET->get("reportid")}' style="height:220px;min-width:300px; margin: 0 auto">
            <br>
            </div>
        </div>
