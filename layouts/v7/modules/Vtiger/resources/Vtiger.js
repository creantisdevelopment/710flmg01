...
//			});
	...
	registerClearReferenceSelectionEvent : function(container) {
		...
		//--Henry# agregue el . (punto) porque no limpiaba el campo
...
//					
	...
	setReferenceFieldValue : function(container, params) {
		...
		if (id && selectedName) {
			if(!fieldDisplayElement.length) {
				...
				//--Henry# quito readonly por disabled para mejorar interfaz
				if(selectedName) {
	...
	*/
	...
	/**
	* @author Piero Collao
	* @description Obtiene el valor de un parametro pasado por GET
	* @param <string> name Nombre del parametro GET
	* @param <string> url Link de donde se desea sacar el parametro, NULL para obetener de la url actual
	*/
