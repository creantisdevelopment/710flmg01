...
<html>
	<head>
        ...
        <script type="text/javascript">
            ...
            {/if}
            /*Creantis-Henry: se agrega el roleid al objeto _USERMETA*/
            var _USERMETA;
            {if $CURRENT_USER_MODEL}
               _USERMETA =  { 'id' : "{$CURRENT_USER_MODEL->get('id')}", 'menustatus' : "{$CURRENT_USER_MODEL->get('leftpanelhide')}", 
                          ...
                          'currencyGroupingPattern' : "{$CURRENT_USER_MODEL->get('currency_grouping_pattern')}", 'truncateTrailingZeros' : "{$CURRENT_USER_MODEL->get('truncate_trailing_zeros')}", 'roleid':"{$CURRENT_USER_MODEL->get('roleid')}", 'date_format':"{$CURRENT_USER_MODEL->get('date_format')}"};
            {/if}
        </script>
    </head>
