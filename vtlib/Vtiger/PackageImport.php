...
class Vtiger_PackageImport extends Vtiger_PackageExport {
		...
		if($module != null) {
			...
			$unzip->unzipAllEx( ".",
				Array(
					...
					'include' => Array('templates', "modules/$module", 'cron', 'languages', 'settings', 'replace_modules', 'replace_layouts', 'vtlib', 'libraries', 'include', 'data', 'cron', 'backup',
				...
				Array(
					// Templates folder
					'templates' => "layouts/v7/modules/$module",
					// Cron folder
					...
					'settings/templates' => "layouts/v7/modules/Settings/$module",
					//module images
					'images' =>   "layouts/v7/skins/images/$module",
					'settings' => "modules/Settings",
					'layouts' => 'layouts',
					// reemplaza cualquier modulo que exista en vtiger
					'replace_modules' => "modules",
					'replace_layouts' => "layouts/v7/modules",
					'languages' => "languages",
					'vtlib' => "vtlib",
					'libraries' => "libraries",
					'include' => "include",
			...
			if($unzip->checkFileExistsInRootFolder("$module.png")) {
				$unzip->unzip("$module.png", "layouts/v7/skins/images/$module.png");
			}
	...
	function import_Module() {
		...
		* Creantis: Henry
		* 2017-12-15
		* Si se trata de un módulo Entidad, se registra en ModTracker
		*/
		if ( $moduleInstance->isentitytype == 1 ) {
			require_once 'modules/ModTracker/ModTrackerUtils.php';
			ModTrackerUtils::modTrac_changeModuleVisibility($moduleInstance->id, $status='module_enable');
		}
	...
	function import_Relatedlist($modulenode, $moduleInstance, $relatedlistnode) {
		...
		if($relModuleInstance) {
			$moduleInstance->setRelatedList($relModuleInstance, "$label", $actions, "$relatedlistnode->function", null, true);
		}
