<?php /* Smarty version Smarty-3.1.7, created on 2019-02-25 17:01:52
         compiled from "/var/www/html/710fleming01/includes/runtime/../../layouts/v7/modules/Vtiger/uitypes/Picklist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5195255145c741f80bde980-38964640%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b31a7d6d70569ae74cc361b85e3d242cbe01e148' => 
    array (
      0 => '/var/www/html/710fleming01/includes/runtime/../../layouts/v7/modules/Vtiger/uitypes/Picklist.tpl',
      1 => 1551113882,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5195255145c741f80bde980-38964640',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c741f80cc5f1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c741f80cc5f1')) {function content_5c741f80cc5f1($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/710fleming01/libraries/Smarty/libs/plugins/modifier.replace.php';
?>
...
</option><?php } ?></select><?php if ($_smarty_tpl->tpl_vars['PICKLIST_COLORS']->value){?><?php $_smarty_tpl->tpl_vars['except'] = new Smarty_variable(array("#fff","#ffffff","#FFF","#FFFFFF"), null, 0);?><style type="text/css"><?php  $_smarty_tpl->tpl_vars['PICKLIST_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->_loop = false;
 $_smarty_tpl->tpl_vars['PICKLIST_NAME'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['PICKLIST_VALUES']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->key => $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value){
$_smarty_tpl->tpl_vars['PICKLIST_VALUE']->_loop = true;
...
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CLASS_NAME'] = new Smarty_variable(($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName())."_".$_tmp2, null, 0);?>.picklistColor_<?php echo $_smarty_tpl->tpl_vars['CLASS_NAME']->value;?>
 {<?php if (!in_array($_smarty_tpl->tpl_vars['PICKLIST_COLORS']->value[$_smarty_tpl->tpl_vars['PICKLIST_NAME']->value],$_smarty_tpl->tpl_vars['except']->value)){?>background-color: <?php echo $_smarty_tpl->tpl_vars['PICKLIST_COLORS']->value[$_smarty_tpl->tpl_vars['PICKLIST_NAME']->value];?>
 !important;<?php }?>}<?php } ?></style><?php }?>
<?php }} ?>